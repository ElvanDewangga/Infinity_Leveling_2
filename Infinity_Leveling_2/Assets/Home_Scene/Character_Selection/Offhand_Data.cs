...
using UnityEngine;
using Starsky;
public class Offhand_Data : MonoBehaviour {


   // Character_Selection :
   public string Code_Terpilih = "Orb_1";  
   public string Offhand_Type = "Sword"; // "Orb" / "Book"
   ...
   public void On_Set_To_Player_2d () {
      ...
      if (Sp_Front) {
         ...
         Sam.transform.SetParent (Home_System.Ins._Character_Selection.Target_Player_2d.Asset_Offhand);
         Sam.transform.localPosition = new Vector3 (0,0,0);
         Sam.SetActive (true);
         // Dont_Destroy_On_Load.Ins._Player_2d.Cur_Hair_Type_Front_GO = Sam;
         Home_System.Ins._Character_Selection.Target_Player_2d.Cur_Offhand_GO = Sam;
   ...
   public void On_Create_Button_To_Character_Selection () {
       //  Home_System.Ins._Character_Selection.On_Increase_Vertical_Layout_Type_1_Skill_Tab_2 ();
        ...
        sc.Code_Box = "Offhand_Data";
        sc.b_Sample = false;
        sc._Offhand_Data = this;
